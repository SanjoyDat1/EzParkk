          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6">
              <motion.a
                ...
                className="flex-1 px-6 py-4 bg-cyan text-dark-bg font-bold rounded-xl text-center hover:bg-cyan/90 transition-colors flex items-center justify-center gap-2"
